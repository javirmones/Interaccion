...
public static List<Usuario> leer ()throws Exception {//metodo para crear la matriz de empleados
    ...
    public static void cargar(String fich)throws Exception{//metodo para cargar el fichero
      String idusuario; String nombre;String apellidos;String email; String DNI; String contrasenia; String fecha; 
      Scanner datos = new Scanner (new FileReader( fich));//creamos el escaner para leer el fichero en funcion del fichero que le introducimos
      ...
      while (datos.hasNext() ){//bucle para leer el fichero mientras hallan lineas que leer
         ...
         Usuario u= new Usuario(idusuario,nombre, apellidos,DNI, email, contrasenia,fecha);
         usuario.add(u);
